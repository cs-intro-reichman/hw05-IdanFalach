...
public class GameOfLife {
    ...
    private static void test2(String fileName) {
        ...
        int livingNeighbors = count(board, 3, 3);
        System.out.println("Living neighbors: " + livingNeighbors);

        int nextGenerationCell = cellValue(board, 3, 3);
        System.out.println("Next generation cell value: " + nextGenerationCell);
    }
